...
class TeamManager extends EventManager {
  ...
  updateWithLineData(data, lineID) {
    // TODO
    // - add parameter to user object like "manualTeamID" to overwrite name/verein ad id
    // - support "staticContent" to add custom other sources of data (manual/ historie)
  ...
  /**
   Reset all teams, called on a timeout
   */
  timeoutReset() {
    this.teams = {};
    this.call("updateAllTeams");
